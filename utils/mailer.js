...
function base(content) {
  ...
  <div style="max-width:520px;margin:0 auto">
    <div style="background:#062318;padding:28px 40px;text-align:center">
      <div style="font-family:Georgia,serif;font-size:30px;font-weight:300;color:#f5efe3">Dorra</div>
      <div style="font-style:italic;font-size:10px;color:rgba(184,145,60,.7);margin-top:4px">THE LUXURY OF NATURE</div>
    </div>
    <div style="padding:32px 40px;background:#f5efe3">${content}</div>
    <div style="background:#062318;padding:14px 40px;text-align:center">
      <p style="font-size:10px;color:rgba(245,239,227,.3);margin:0">dorrastonejewelry@gmail.com | @dorrastones</p>
    </div>
  </div></body></html>`;
}
  ...
  try {
    await transporter.sendMail({
      ...
      html: base(`
        ...
        <p style="font-size:12px;color:#7a6040">Questions? DM us <strong>@dorrastones</strong></p>
      `),
    });
